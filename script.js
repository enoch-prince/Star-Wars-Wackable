...
function startGame() {
  ...
  let startCountDown = setInterval(() => {
    ...
    if (countdown < 0) {
      ...
      countdown_board.textContent =
        "Time's UP!! Yoooo. May the force be with you 🍟";
    }
...
function whack(e) {
  score++; //this will increment the value of our score
  this.style.backgroundImage = 'url("imgs/yoda2.png")'; //this will change the image of yoda from happy to sad
  this.style.pointerEvents = "none"; //this will disable all pointer events
...
yodas.forEach((yoda) => {
  yoda.addEventListener("click", whack);
});
